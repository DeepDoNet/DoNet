...
from .During_Train_Amodal_cocoeval import DuringTrainAMODALCOCOeval
...
class DuringTrainAmodalEvaluator(DatasetEvaluator):
    """
    ...
    def evaluate(self):
        ...
        if self._results['segm']['AP'] > self._best_seg_AP:
            self._best_seg_AP = self._results['segm']['AP']
            self._results["best"] = {'segm_AP':True, 'current_best': self._best_seg_AP}
        else:
            self._results["best"] = {'segm_AP':False, 'current_best': self._best_seg_AP}
...
def _evaluate_predictions_on_coco(coco_gt, coco_results, iou_type, kpt_oks_sigmas=None):
    ...
    coco_eval = DuringTrainAMODALCOCOeval(coco_gt, coco_dt, iou_type)
