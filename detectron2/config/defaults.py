...
# ---------------------------------------------------------------------------- #
# Double Branch Whole Mask Head
# ---------------------------------------------------------------------------- #
_C.MODEL.ROI_DOUBLE_BRANCH_WHOLE_MASK_HEAD = CN()
_C.MODEL.ROI_DOUBLE_BRANCH_WHOLE_MASK_HEAD.NAME = "AmodalMaskRCNNHead"
_C.MODEL.ROI_DOUBLE_BRANCH_WHOLE_MASK_HEAD.POOLER_RESOLUTION = 14
_C.MODEL.ROI_DOUBLE_BRANCH_WHOLE_MASK_HEAD.POOLER_SAMPLING_RATIO = 0
_C.MODEL.ROI_DOUBLE_BRANCH_WHOLE_MASK_HEAD.NUM_CONV = 0  # The number of convs in the mask head
_C.MODEL.ROI_DOUBLE_BRANCH_WHOLE_MASK_HEAD.CONV_DIM = 256
# Normalization method for the convolution layers.
# Options: "" (no norm), "GN", "SyncBN".
_C.MODEL.ROI_DOUBLE_BRANCH_WHOLE_MASK_HEAD.NORM = ""
# Whether to use class agnostic for mask prediction
_C.MODEL.ROI_DOUBLE_BRANCH_WHOLE_MASK_HEAD.CLS_AGNOSTIC_MASK = False
# Type of pooling operation applied to the incoming feature map for each RoI
_C.MODEL.ROI_DOUBLE_BRANCH_WHOLE_MASK_HEAD.POOLER_TYPE = "ROIAlignV2"
# ---------------------------------------------------------------------------- #
# Double Branch Overlapping Mask Head
# ---------------------------------------------------------------------------- #
_C.MODEL.ROI_DOUBLE_BRANCH_OVERLAPPING_MASK_HEAD = CN()
_C.MODEL.ROI_DOUBLE_BRANCH_OVERLAPPING_MASK_HEAD.NAME = "AmodalMaskRCNNHead"
_C.MODEL.ROI_DOUBLE_BRANCH_OVERLAPPING_MASK_HEAD.POOLER_RESOLUTION = 14
_C.MODEL.ROI_DOUBLE_BRANCH_OVERLAPPING_MASK_HEAD.POOLER_SAMPLING_RATIO = 0
_C.MODEL.ROI_DOUBLE_BRANCH_OVERLAPPING_MASK_HEAD.NUM_CONV = 0  # The number of convs in the mask head
_C.MODEL.ROI_DOUBLE_BRANCH_OVERLAPPING_MASK_HEAD.CONV_DIM = 256
# Normalization method for the convolution layers.
# Options: "" (no norm), "GN", "SyncBN".
_C.MODEL.ROI_DOUBLE_BRANCH_OVERLAPPING_MASK_HEAD.NORM = ""
# Whether to use class agnostic for mask prediction
_C.MODEL.ROI_DOUBLE_BRANCH_OVERLAPPING_MASK_HEAD.CLS_AGNOSTIC_MASK = False
# Type of pooling operation applied to the incoming feature map for each RoI
_C.MODEL.ROI_DOUBLE_BRANCH_OVERLAPPING_MASK_HEAD.POOLER_TYPE = "ROIAlignV2"

# ---------------------------------------------------------------------------- #
# Triple Branch Whole Mask Head
# ---------------------------------------------------------------------------- #
_C.MODEL.ROI_TRIPLE_BRANCH_WHOLE_MASK_HEAD = CN()
_C.MODEL.ROI_TRIPLE_BRANCH_WHOLE_MASK_HEAD.NAME = "AmodalMaskRCNNHead"
_C.MODEL.ROI_TRIPLE_BRANCH_WHOLE_MASK_HEAD.POOLER_RESOLUTION = 14
_C.MODEL.ROI_TRIPLE_BRANCH_WHOLE_MASK_HEAD.POOLER_SAMPLING_RATIO = 0
_C.MODEL.ROI_TRIPLE_BRANCH_WHOLE_MASK_HEAD.NUM_CONV = 0  # The number of convs in the mask head
_C.MODEL.ROI_TRIPLE_BRANCH_WHOLE_MASK_HEAD.CONV_DIM = 256
# Normalization method for the convolution layers.
# Options: "" (no norm), "GN", "SyncBN".
_C.MODEL.ROI_TRIPLE_BRANCH_WHOLE_MASK_HEAD.NORM = ""
# Whether to use class agnostic for mask prediction
_C.MODEL.ROI_TRIPLE_BRANCH_WHOLE_MASK_HEAD.CLS_AGNOSTIC_MASK = False
# Type of pooling operation applied to the incoming feature map for each RoI
_C.MODEL.ROI_TRIPLE_BRANCH_WHOLE_MASK_HEAD.POOLER_TYPE = "ROIAlignV2"
# ---------------------------------------------------------------------------- #
# Triple Branch Overlapping Mask Head
# ---------------------------------------------------------------------------- #
_C.MODEL.ROI_TRIPLE_BRANCH_OVERLAPPING_MASK_HEAD = CN()
_C.MODEL.ROI_TRIPLE_BRANCH_OVERLAPPING_MASK_HEAD.NAME = "AmodalMaskRCNNHead"
_C.MODEL.ROI_TRIPLE_BRANCH_OVERLAPPING_MASK_HEAD.POOLER_RESOLUTION = 14
_C.MODEL.ROI_TRIPLE_BRANCH_OVERLAPPING_MASK_HEAD.POOLER_SAMPLING_RATIO = 0
_C.MODEL.ROI_TRIPLE_BRANCH_OVERLAPPING_MASK_HEAD.NUM_CONV = 0  # The number of convs in the mask head
_C.MODEL.ROI_TRIPLE_BRANCH_OVERLAPPING_MASK_HEAD.CONV_DIM = 256
# Normalization method for the convolution layers.
# Options: "" (no norm), "GN", "SyncBN".
_C.MODEL.ROI_TRIPLE_BRANCH_OVERLAPPING_MASK_HEAD.NORM = ""
# Whether to use class agnostic for mask prediction
_C.MODEL.ROI_TRIPLE_BRANCH_OVERLAPPING_MASK_HEAD.CLS_AGNOSTIC_MASK = False
# Type of pooling operation applied to the incoming feature map for each RoI
_C.MODEL.ROI_TRIPLE_BRANCH_OVERLAPPING_MASK_HEAD.POOLER_TYPE = "ROIAlignV2"
# ---------------------------------------------------------------------------- #
# Triple Branch Non-Overlapping Mask Head
# ---------------------------------------------------------------------------- #
_C.MODEL.ROI_TRIPLE_BRANCH_NONOVERLAPPING_MASK_HEAD = CN()
_C.MODEL.ROI_TRIPLE_BRANCH_NONOVERLAPPING_MASK_HEAD.NAME = "AmodalMaskRCNNHead"
_C.MODEL.ROI_TRIPLE_BRANCH_NONOVERLAPPING_MASK_HEAD.POOLER_RESOLUTION = 14
_C.MODEL.ROI_TRIPLE_BRANCH_NONOVERLAPPING_MASK_HEAD.POOLER_SAMPLING_RATIO = 0
_C.MODEL.ROI_TRIPLE_BRANCH_NONOVERLAPPING_MASK_HEAD.NUM_CONV = 0  # The number of convs in the mask head
_C.MODEL.ROI_TRIPLE_BRANCH_NONOVERLAPPING_MASK_HEAD.CONV_DIM = 256
# Normalization method for the convolution layers.
# Options: "" (no norm), "GN", "SyncBN".
_C.MODEL.ROI_TRIPLE_BRANCH_NONOVERLAPPING_MASK_HEAD.NORM = ""
# Whether to use class agnostic for mask prediction
_C.MODEL.ROI_TRIPLE_BRANCH_NONOVERLAPPING_MASK_HEAD.CLS_AGNOSTIC_MASK = False
# Type of pooling operation applied to the incoming feature map for each RoI
_C.MODEL.ROI_TRIPLE_BRANCH_NONOVERLAPPING_MASK_HEAD.POOLER_TYPE = "ROIAlignV2"
# ---------------------------------------------------------------------------- #
# Recls of mask head
# ---------------------------------------------------------------------------- #
